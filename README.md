...
│   │  ── MBSE / SysML v2 ──
│   ├── new-sysml-model.md   — /new-sysml-model Layered SysML v2 model scaffold
│   └── sysml-validate.md    — /sysml-validate  Pilot-kernel validation + SVG diagrams
...
│   │  ── MBSE / SysML v2 / MATLAB ──
│   ├── sysml_v2_modeling/         — SysML v2 modeling + scripts/sysml_validate.py
│   └── system_composer_sysml/     — SysML v2 ↔ System Composer / Simulink via MATLAB MCP
...
│   ├── sysml_v2.md                — SysML v2 notation, conventions, ROS 2 mapping, pitfalls
│   ├── matlab_simulink_mbse.md    — MATLAB MCP / Simulink Agentic Toolkit / System Composer ↔ SysML v2
...
└── agents/              # custom sub-agent definitions
    ...
    │  ── MBSE / SysML v2 ──
    ├── sysml-reviewer.md          — SysML v2 model reviewer (validator + conventions + traceability)
    └── mbse-architect.md          — System decomposition / requirement-tree advisor
```
...
MBSE side:
* `subagent_type: "sysml-reviewer"` — validates SysML v2 models and
  audits conventions, value provenance and requirement traceability.
* `subagent_type: "mbse-architect"` — optioned recommendations on
  decomposition, interfaces, requirement trees and the SysML/Simulink split.
